<template>
  <header class="bg-white shadow">
    <nav class="container mx-auto flex items-center justify-between py-4 px-6">
      <!-- Logo -->
      <div>
        <img src="../assets/media/logo.jpg" alt="Logo" class="w-8 h-8" />
      </div>
      ...
      <ul class="hidden md:flex items-center space-x-4">
        ...
        <li>
          <a href="#" class="text-gray-800 hover:text-blue-600">Universities</a>
        </li>
        <li>
          <a href="#" class="text-gray-800 hover:text-blue-600">Programs</a>
        </li>
        <li>
      ...
      <transition name="fade">
        ...
        >
          ...
          <li>
            <a href="#" class="block text-gray-800 hover:text-blue-600">Universities</a>
          </li>
          <li>
            <a href="#" class="block text-gray-800 hover:text-blue-600">Programs</a>
          </li>
          <li>
